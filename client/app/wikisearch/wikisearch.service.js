...
angular.module('timelineApp')
  .factory('wikisearch', function ($http) {
    ...
    result.findName = function(input){
      var results = [];
      var api = "https://en.wikipedia.org/w/api.php?format=json&action=query&generator=search&gsrnamespace=92&gsrlimit=5&prop=pageimages|extracts&pilimit=max&exintro&explaintext&exlimit=max&gsrsearch="
